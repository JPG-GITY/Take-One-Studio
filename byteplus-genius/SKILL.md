...
| **Seedance 2.5** video generation (R2V multimodal), its model IDs, asset/reference limits, locked vs unlocked tasks, keyframes, storyboards, editing & extension, and how 2.5 differs from 2.0. For 2.0 / Fast / Mini use the 2.0 file instead. | `references/video-seedance-2.5.md` |
...
| The authoritative **Seedance 2.5 prompt-optimization contract** (`sd25-pe`): the full rule set for optimizing text/story/multimodal input into 2.5 prompts. Read this before hand-writing a 2.5 prompt. | `references/seedance-2.5-prompt-optimizer-SKILL.md` |
| **Seed 2.1 Turbo** (`dola-seed-2-1-turbo-260628`) — identity, and a measured A/B against Seed 2.0 Pro. Note its adoption status before recommending it. | `references/llm-seed-2-1-turbo.md` |
